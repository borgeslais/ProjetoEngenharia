...
data Material = Material { nomeMaterial :: String
                , densidade :: Densidade
...
data CalculoMat = CalculoMat { nomeCalculo :: String
                  , entrada :: [Double]
                  , resultado :: Double
                  , unidade :: String
                  , formula :: String
...
data SecaoTransversal = SecaoRetangular Largura Altura
                        | SecaoCircular Raio
                        | SecaoI Altura Largura Espessura Espessura
                        deriving (Show, Eq)

data TipoFuncao = Linear Double Double
                -- ax + b
                | Quadratica Double Double Double -- ax² + bx + c
                | Exponencial Double Double
                -- a * e^(bx)
                | Logaritmica Double Double
                -- a * ln(bx)
